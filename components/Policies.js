...
const policies = [
  ...
  { title: 'สุขใดเล่าจะเท่าสุขา', desc: 'ห้องน้ำสะอาด' },
  { title: 'สานต่อนโยบาย', desc: 'สืบต่อจากรุ่นพี่' },
  ...
  { title: 'สนับสนุน E-sport', desc: 'จัดแข่งขันในโรงเรียน' },
  { title: 'ธนาคารข้อสอบเก่า', desc: 'แจกข้อสอบเก่า' },
  { title: 'Thunder Delivery', desc: 'ของหายพี่หา' },
